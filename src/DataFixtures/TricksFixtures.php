        ...
        for ($nbTricks=1; $nbTricks <= 40 ; $nbTricks++) { 
            ...
            for ($nbembedded=0; $nbembedded <= 2 ; $nbembedded++) { 
                $embedded = array(
                    ...
                    '3'=>'<iframe width="560" height="315" src="https://www.youtube.com/embed/0uGETVnkujA?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                    '4'=>'<iframe width="560" height="315" src="https://www.youtube.com/embed/5zH-YEvyztA?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                    '5'=>'<iframe width="560" height="315" src="https://www.youtube.com/embed/-27nqjI844I?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
                    '6'=>'<iframe width="560" height="315" src="https://www.youtube.com/embed/OCdcewbfieY?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                );
                shuffle($embedded);    
